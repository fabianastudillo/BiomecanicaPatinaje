...
def write_csv(video_name, angles, vet):
    ...
    with open('SVM/datos.csv', 'a', newline='') as f:
        writer = csv.writer(f)
...
# carpeta='ArchivosJSON/Lateral/11_03/vid49'
...
count=0
dist_real=13.7                              #Distancia real que se capta en un video lateral
...
VET=calcular_vet(keypointssmooth.copy(), waist_movement, dist_real, fps)



name = carpeta.replace("ArchivosJSON/Lateral_nombre/", "")
name = name.replace("/", "_")
gei_name = "GEI/"+name+".png"

write_csv(name, AngMaxMin, VET)

# write_csv1(name, Angulos[0],'Ang0')
# write_csv1(name, Angulos[1],'Ang1')
# write_csv1(name, Angulos[2],'Ang2')
# write_csv1(name, Angulos[3],'Ang3')
# write_csv1(name, Angulos[4],'Ang4')
# write_csv1(name, Angulos[5],'Ang5')
# write_csv1(name, Angulos[6],'Ang6')
# write_csv1(name, Angulos[7],'Ang7')
# write_csv1(name, Angulos[8],'Ang8')
# write_csv1(name, Angulos[9],'Ang9')
